    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
            ...
            <div class="pageheader">
                ...
                <h2><i class="fa fa-thumb-tack" style="line-height: 48px;padding-left: 1px;"></i> Create SIM
                    ...
                    <div class="col-md-6">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <div class="tile-body">
                                ...
                                <form action="CreateSIM" method="post" class="form-horizontal" role="form">

                                    <div class="form-group">
                                        <label for="input01" class="col-sm-4 control-label">Subscriber CIN </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Select a Service Type </label>
                                    ...
                                    <div id="ifYes" style="display: block;">
                                        <div class="form-group">
                                            <label for="input01" class="col-sm-4 control-label">Geographic Localisation</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="GeoLocal">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="ifNo" style="display: none;">
                                        ...
                                        <div class="form-group">
                                        <label  class="col-sm-4 control-label">Select a Connection Type </label>
                                        <SELECT  name="SIMConnectionType">
                                            <OPTION id="3G" SELECTED> 3G</OPTION>
                                            <OPTION id="4G" > 4G</OPTION>
                                        </SELECT>
                                        ...
                                        <div class="form-group">
                                        <label  class="col-sm-4 control-label">Select a Network Type </label>
                                        <SELECT name="SIMNetworkType">
                                            <OPTION id="type1" SELECTED> type1</OPTION>
                                            <OPTION id="type2" > type2</OPTION>
                                            <OPTION id="type3" > type3</OPTION>
                                        ...
                                        <div class="form-group">
                                        <label  class="col-sm-4 control-label">Select a Payment Type </label>
                                        <SELECT name="SIMPaymentType">
                                            <OPTION id="cash" SELECTED> cash</OPTION>
                                            <OPTION id="paypal" > paypal</OPTION>
                                            <OPTION id="check" > check</OPTION>
