                    ...
                    <div class="col-md-6">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <div class="tile-body">
                                ...
                                <form action="CreateEmployee" method="post" class="form-horizontal" role="form">

                                    <div class="form-group">
                                        <label for="input01" class="col-sm-4 control-label">CIN</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="input01" class="col-sm-4 control-label">FamilyName</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="Address" id="input01">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Select a Service to affect  </label>
